package kr.co.kwonshzzang.designpattern.abstractfactory;
...
public class Main {
    public static void main(String[] args) {
        if(args.length != 1) {
            ...
            System.out.println("Example 1: java Main kr.co.kwonshzzang.designpattern.abstractfactory.listfactory.ListFactory");
            System.out.println("Example 2: java Main kr.co.kwonshzzang.designpattern.abstractfactory.tablefactory.TableFactory");
            System.exit(0);
        }
        ...
        Page page = factory.createPage("Linkage", "영진닷컴");
        page.add(traynews);
        page.add(traysearch);
        page.output();
    }
